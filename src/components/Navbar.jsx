...
import manImg from "../image/man-img.png";

function Navbar() {
  return (
    <section>
      <div className="flex items-center flex-col gap-8 px-38px py-9 bg-[#161D2F] rounded-20px">
        <a className="mb-[74px]" href="">
          <img src={movie} alt="movia icon" />
        </a>
        <ul className="flex flex-col gap-9 mb-[552px]">
          <li>
